          ...
          >
            <Card className="bg-transparent border-0 shadow-none">
              ...
              <CardContent className="space-y-6">
                ...
                {file && (
                  <div className="p-4 bg-gradient-to-r from-gray-800/60 to-gray-700/60 rounded-xl border border-gray-700/60">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg flex items-center justify-center">
                        <FileText className="h-5 w-5 text-white" />
                      </div>
                      <div className="flex-1">
                        <div className="font-semibold text-gray-100">{file.name}</div>
                        <div className="text-sm text-gray-300">{(file.size/1024/1024).toFixed(2)} MB</div>
                      </div>
                    </div>
                  </div>
                )}
                    ...
                    <div className="flex items-center gap-3">
                      {duplicateCheck.isDuplicate ? (
                        ...
                        <>
                          ...
                          <div>
                            <div className="font-semibold text-green-300">Ready to Upload</div>
                            <div className="text-sm text-green-400">Document is unique and ready for processing</div>
                          </div>
                        </>
                      )}
                    </div>
                ...
                {duplicateCheck?.summaryText && (
                  <div className="space-y-4 p-4 rounded-xl border bg-gradient-to-r from-gray-800/60 to-gray-700/60 border-gray-700/60">
                    ...
                    <p className="text-sm text-gray-200 leading-relaxed whitespace-pre-wrap line-clamp-3">
                      {duplicateCheck.summaryText}
                    </p>
                    <div className="flex gap-3">
                      ...
                      <Button onClick={onClose} variant="outline" className="bg-gray-800/60">Close</Button>
                    </div>
                  </div>
                )}
                {!duplicateCheck?.summaryText && (
